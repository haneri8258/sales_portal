...
class MngManagerList extends Component {
	...
	render() {
		...
		const columns = [
			...
			{ name: " ", header: "거래처 SKU 코드", width: 150, sortable: true,align: "center"},
			{ name: " ", header: "BUYER code", width: 150, sortable: true,align: "right" },
			{ name: " ", header: "FnSKU", width: 150, sortable: true,align: "center" },  
			{ name: " ", header: "사용여부", width: 200, sortable: true,align: "left" },
		];
